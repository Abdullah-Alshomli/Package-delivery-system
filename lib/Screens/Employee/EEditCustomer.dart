...
class _EEditCustomer extends State<EEditCustomer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Edit Customer", style: TextStyle(color: Color(0xFFFFFFFF),fontSize: 30),),centerTitle: true,backgroundColor: Colors.blueGrey,),
      body: Center(
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  width: 200,
                  child: ElevatedButton(onPressed: () {
                    editCustomer( email,  name,  country,  city,  reigon,  zipcode);
